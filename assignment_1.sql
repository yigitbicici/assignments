...
*/
/*at the first query, We can see customer's purchase like a group and these invoices ordered from higher to lower. 
And at he second query, we retrived firstly the biggest emount of invoices and then if there is same amount invoices that we can see which customers purchased for it and costomers ordered by customers ID*/
